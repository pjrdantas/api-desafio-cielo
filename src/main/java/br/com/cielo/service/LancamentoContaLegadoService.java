...
public class LancamentoContaLegadoService implements ILancamentoContaLegadoService {
	...
	public void addLancamentoContaLegado(LancamentoContaLegado lancamentoContaLegado) throws Exception, Throwable {
		...
		for (ListaControleLancamento listaControleLancamento : listaControleLancamentos) {
			...
			tbExtratoDTO.setDadosBancario(listaControleLancamento.getNomeBanco() + "Ag.: "
					+ listaControleLancamento.getLancamentoContaCorrenteCliente().getDadosDomicilioBancario()
							.getNumeroAgencia()
					+ " / CC.: " + listaControleLancamento.getLancamentoContaCorrenteCliente()
							.getDadosDomicilioBancario().getNumeroContaCorrente()
					+ listaControleLancamento.getValorLancamentoRemessa());
			...
			tbExtratoDTO
					.setDescricao(listaControleLancamento.getLancamentoContaCorrenteCliente().getNomeSituacaoRemessa());
			tbExtratoDTO.setNumero(listaControleLancamento.getNumeroEvento());
